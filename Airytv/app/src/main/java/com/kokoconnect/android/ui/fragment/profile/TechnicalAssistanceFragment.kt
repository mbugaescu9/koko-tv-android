...
import com.kokoconnect.android.databinding.FragmentTechnicalAssistanceBinding
...
class TechnicalAssistanceFragment : BaseFragment(), Injectable {
    var binding: FragmentTechnicalAssistanceBinding? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentTechnicalAssistanceBinding.inflate(inflater, container, false)
        return binding?.root
    }
    ...
    private fun submit() {
        ...
        lifecycleScope.launch {
            setSubmitEnabled(false)
            val sent = profileViewModel.sendFeedback(text)
