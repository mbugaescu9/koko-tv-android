...
public final class HlsMediaSource extends BaseMediaSource
  ...
  /** Listener for detect #EXT-X-CUE-OUT in hls stream. */
  public interface DetectXCueOutListener {

    /**
     * Called when detect #EXT-X-CUE-OUT.
     */
    public void onStartAds(String cueTagValue);
  }
  ...
  public static final class Factory implements MediaSourceFactory {
    ...
    private DetectXCueOutListener detectXCueOutListener;
    ...
    public Factory setXCueOutListener(DetectXCueOutListener detectXCueOutListener) {
      Assertions.checkState(!isCreateCalled);
      this.detectXCueOutListener = Assertions.checkNotNull(detectXCueOutListener);
      return this;
    }
  ...
  private final DetectXCueOutListener detectXCueOutListener;
  ...
  private HlsMediaSource(
      ...
      @Nullable Object tag,
      HlsMediaSource.DetectXCueOutListener detectXCueOutListener) {
    ...
    this.useSessionKeys = useSessionKeys;
    this.tag = tag;
    this.detectXCueOutListener = detectXCueOutListener;
  }
