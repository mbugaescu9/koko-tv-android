...
/* package */ final class HlsSampleStreamWrapper implements Loader.Callback<Chunk>,
  ...
  private HlsMediaSource.DetectXCueOutListener detectXCueOutListener;
...
*     DrmSessions} with.
  ...
  public HlsSampleStreamWrapper(
          ...
          @HlsMediaSource.MetadataType int metadataType, HlsMediaSource.DetectXCueOutListener detectXCueOutListener) {
  ...
  public int readData(int sampleQueueIndex, FormatHolder formatHolder, DecoderInputBuffer buffer,
    ...
    if (!mediaChunks.isEmpty()) {
      ...
      if (currentChunk.dataSpec.key != null) {
        handler.post(() -> detectXCueOutListener.onStartAds(currentChunk.dataSpec.key));
      }
