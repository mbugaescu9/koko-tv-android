...
public final class HlsMediaPlaylist extends HlsPlaylist {
  ...
  public static final class Segment implements Comparable<Long> {
    ...
    /** Whether the segment is tagged with #EXT-X-CUE-OUT or EXT-X-CUE-OUT-CONT. */
    public final boolean isCueTag;

    /** Which tag is detected #EXT-X-CUE-OUT or EXT-X-CUE-OUT-CONT. */
    public final String cueTagValue;
    ...
    public Segment(
      ...
      this.isCueTag = idXCue;
      this.cueTagValue = cueTagValue;
    }
