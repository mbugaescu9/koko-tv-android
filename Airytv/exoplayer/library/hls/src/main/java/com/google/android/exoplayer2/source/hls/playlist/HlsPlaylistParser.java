...
public final class HlsPlaylistParser implements ParsingLoadable.Parser<HlsPlaylist> {
  ...
  private static final String TAG_X_CUE_OUT = "#EXT-X-CUE-OUT";
  private static final String TAG_X_CUE_OUT_CONT = "#EXT-X-CUE-OUT-CONT";
  private static final String TAG_X_CUE_IN = "#EXT-X-CUE-IN";
  ...
  private static HlsMediaPlaylist parseMediaPlaylist(
    ...
    boolean nextTagIsXCue = false;
    String nextTagXCueValue = null;
    ...
    while (iterator.hasNext()) {
      ...
      if (line.startsWith(TAG_PLAYLIST_TYPE)) {
        ...
        segmentByteRangeLength = C.LENGTH_UNSET;
        hasGapTag = false;
      } else if (line.startsWith(TAG_X_CUE_OUT)) {
        nextTagIsXCue = true;
        nextTagXCueValue = line;
      }
    }
